                  ...
                  return SizedBox(
                    ...
                    child: ListView.separated(
                      ...
                      return _newProductController.isNewInProgress ? const ShimmerCard() : ProductCard(
                        ...
                        rating: (_newProductController.newProductModel.data?[index].star ?? 0).toInt(),
                      );
                    },
                      separatorBuilder: (BuildContext context, int index) {
                        return const SizedBox(
             ...
             TextField(
              ...
              GetBuilder<ProductController>(
                builder: (_popularProductController) {
                  return SizedBox(
                    height: 170,
                    child: _popularProductController.isPopularInProgress
                        ? ListView.separated(
                      scrollDirection: Axis.horizontal,
                      itemCount: _popularProductController.productModel.data?.length ?? 4,
                      itemBuilder: (context, index) {
                        return  Stack(
                          children: [
                            Center(
                      ...
                      separatorBuilder: (BuildContext context, int index) {
                        ...
                        : ListView.separated(
                      scrollDirection: Axis.horizontal,
                      itemCount: _popularProductController.productModel.data?.length ?? 0,
                      itemBuilder: (context, index) {
                        return  ProductCard(
                          image: _popularProductController.productModel.data?[index].image ?? '',
                          title: _popularProductController.productModel.data?[index].title ?? '',
                          price: _popularProductController.productModel.data?[index].price ?? '',
                          rating: (_popularProductController.productModel.data?[index].star)?.toInt() ?? 0,
                        );
                      },
                      separatorBuilder: (BuildContext context, int index) {
                        return const SizedBox(
